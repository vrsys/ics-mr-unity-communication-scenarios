...
public class CrossPrimitive {
        ...
        vertices[4] = new Vector3(-0.1f, 0.3f, 0f);
        vertices[5] = new Vector3(0.1f, 0.3f, 0f);
        vertices[6] = new Vector3(0.4f, 0.1f, 0f);
        vertices[7] = new Vector3(0.4f, -0.1f, 0f);

        vertices[8] = new Vector3(0.1f, -0.3f, 0f);
        vertices[9] = new Vector3(-0.1f, -0.3f, 0f);
        vertices[10] = new Vector3(-0.4f, -0.1f, 0f);
        vertices[11] = new Vector3(-0.4f, 0.1f, 0f);

        vertices[12] = new Vector3(-0.2f, 0.3f, 0f);
        vertices[13] = new Vector3(0f, 0.4f, 0f);
        vertices[14] = new Vector3(0.2f, 0.3f, 0f);

        vertices[15] = new Vector3(0.4f, 0.2f, 0f);
        vertices[16] = new Vector3(0.5f, 0f, 0f);
        vertices[17] = new Vector3(0.4f, -0.2f, 0f);

        vertices[18] = new Vector3(0.2f, -0.3f, 0f);
        vertices[19] = new Vector3(0f, -0.4f, 0f);
        vertices[20] = new Vector3(-0.2f, -0.3f, 0f);
