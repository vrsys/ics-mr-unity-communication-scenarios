     ...
     public class FourPointSunPrimitive {
         #if UNITY_EDITOR
        ...
        int[] triangles = { 0,8,23,2,12,11,4,16,15,6,20,19,
         ...
         private static GameObject CreateObject() {
             var obj = new GameObject("FourPointSun");
             var mesh = CreateMesh();
        ...
        string path = "Assets/GeneratedMeshes/SunFourPointMesh.asset";
        SaveAsset.SaveMeshAsset(mesh, path);

        return obj;
         }
     
         [MenuItem("GameObject/3D Object/FourPointSun", false, 0)]
