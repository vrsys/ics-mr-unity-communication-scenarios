     ...
     public class SunPrimitive {
        ...
        int[] triangles = { 0,8,23,1,10,9,2,12,11,3,14,13,4,16,15,5,18,17,6,20,19,7,22,21,
        ...
        string path = "Assets/GeneratedMeshes/SunMesh.asset";
        SaveAsset.SaveMeshAsset(mesh, path);

        return obj;
         }
     
         [MenuItem("GameObject/3D Object/Sun", false, 0)]
